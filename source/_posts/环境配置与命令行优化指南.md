...
``` powershell
# 安装常用软件
scoop install aria2 scoop-search gsudo grep gzip localsend honeyview chsrc everything magpie notepad3 pandoc pixpin quicklook winget OfficeToolPlus-Portable scoop-completion vscode
