...
<img src="https://misaka12843.oss-cn-hangzhou.aliyuncs.com/img/image-20240625015248762-1719251570352-3.png" alt="海豹图标" style="zoom: 50%;" />

然后在任务栏的右下角找到图标，左键打开菜单然后单击打开界面即可。
...
> 另外可以在“综合设置/基本设置”中找到 Master 解锁码，将解锁码通过 QQ 发送给骰娘就可以方便的获取到 Master 权限。
...
检查下`Lagrange.OneBot.exe`还在不在该文件夹里面，如果不在或误删了，可以在下载页面重新下载一个海豹，用里面的`Lagrange.OneBot.exe`替换进来。然后再重新启动海豹核心，获取二维码就能成功。
